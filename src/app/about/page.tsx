          ...
          <div className="container px-5 py-5 mb-5 mx-auto flex flex-col">
            <div className="lg:w-5/6 mx-auto">
              ...
              <div className="flex flex-col sm:flex-row mt-10">
                ...
                <Image src={"/pic/pro.jpeg"} alt="shaf" width={100} height={100} className="rounded-full"/>
                  </div>
                  <div className="flex flex-col items-center text-center justify-center">
                    ...
                    I am Muhammad Taha Siddiqui, a professional Front-End Developer with a strong passion for AI and emerging technologies. I excel in designing and developing visually captivating, user-centric websites, seamlessly blending creativity with technical expertise to deliver exceptional digital experiences 
                    </p>
                  </div>
                </div>
